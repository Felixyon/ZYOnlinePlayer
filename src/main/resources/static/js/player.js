...
console.info('十分感谢mengkun大佬的源代码，我在上面做了些基础的修改，\n将音乐源缩减为网易云，并用java重新搭建了一个后台，\n因为服务器性能较差，所以同样没有开放跨域请求。相对而言，\n java后台的部署比较方便。欢迎大家使用该后台快速上手mengkun大佬的项目。\n 为了保证原作者的代码SEO可以排在前面，所以将该项目名称做些修改。');
console.info('Github: https://github.com/Felixyon/ZYOnlinePlayer');
